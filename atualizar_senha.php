   ...
   // var_dump($dados);
    if (!empty($dados['SendNovaSenha'])){
      ...
      if($result_up_usuario->execute()){
        $_SESSION['msg']="<p style='color:green'>senha actualizada com sucesso</p>";
    ...
    $_SESSION['msg_rec']="<p style='color:#ff0000'>erro: link invalido solicite um ovo link para actualizar a senha</p>";
    ...
    <form method="POST" action="">
      ...
      <label>Senha</label>
      <input type="password" name="senha_usuario" placeholder="Digite a nova senha senha"value="<?php echo $usuario; ?>"><br><br>
      <br>
      <br>
